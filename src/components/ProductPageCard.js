    ...
    <>
      <div className='productcard-container'>
          ...
          <div className='productcard_info_container'>
            <p className='productcard_info'>The Jade Plant was originated in South Africa, but has been cultivated in America and Europe as a house plant. The grow good in containers and like warm, dry climated often found in most homes </p>
          </div>
